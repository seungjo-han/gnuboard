		...
		<div class="d-flex">
			<div id="faq_cate_list" class="sly-wrap flex-grow-1">
				...
				<?php
					//분류 정리
					na_script('sly');
					$gr_qstr = 'view='.$view.'&amp;mb_id='.$mb_id;
					$gn = $gr_select = 0;
					$gr_start = ($gr_id) ? '' : ' class="active"';
				?>
				<li<?php echo $gr_start ?>>
					<a class="py-2 px-3" href="<?php echo G5_BBS_URL ?>/new.php?<?php echo $gr_qstr ?>">전체</a>
				</li>
				<?php
					$gn++;
					$gr_name = '';
				...
				?>
					<li<?php echo $gr_active ?>>
						<a class="py-2 px-3" href="<?php echo G5_BBS_URL ?>/new.php?gr_id=<?php echo $row['gr_id'] ?>&amp;<?php echo $gr_qstr ?>">
