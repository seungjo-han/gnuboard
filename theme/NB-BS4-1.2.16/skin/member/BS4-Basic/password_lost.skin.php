...
<div id="find_info" class="f-de mb-5<?php if($config['cf_cert_use'] != 0 && $config['cf_cert_find'] != 0) { ?> cert<?php } ?>">
    ...
    <div class="text-center border-top px-3 px-sm-0 my-3">
        <h3 class="py-4">본인인증으로 찾기</h3>
		<p>
