...
<div class="f-de mb-5">
	...
	<input type="hidden" name="cert_no" value="">
		...
		<section class="px-3 px-sm-0 mb-4" id="member_cert_refresh_private">
			
			<h4 class="mb-3">(필수) 추가 개인정보처리방침 안내</h4>
			...
			<div class="custom-control custom-checkbox">
				...
				<label class="custom-control-label" for="agree21"><span>추가 개인정보처리방침에 동의합니다.</span></label>
			</div>
		</section>

        <section id="find_info" class="text-center border-top px-3 px-sm-0 my-3">

			<h3 class="py-4">인증수단 선택하기</h3>
